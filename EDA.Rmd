...
Check the number of rows and columns of data frame
...
Check the mean, median, and standard deviation for the Sales Price:
...
Check the mean, median, and standard deviation for the total rooms above grade:
...
Check the mean, median, and standard deviation for the Overall Condition:
...
First, we note again that the majority of the houses have average condition, then about 1/3 have above average condition, then less than 10% have below average condition. As we might expect, the average condition therefore contains houses across a broader spectrum of the sale price range than either the below-average or above-average houses.
